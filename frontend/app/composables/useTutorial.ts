...
export const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    description: 'Bu interaktiv tur 11 addımda portalın bütün əsas funksiyalarını sizə tanıdacaq — qrup yaratmaqdan AI-dəstəkli xərc analitikasına qədər.',
    target: null,
    placement: 'center',
  },
  {
  ...
  },
  {
    ...
    description: 'Xərc detalına keçin: solda orijinal qaimə şəkli, sağda AI-nin oxuduğu məlumatlar. Düzəliş edib "Təsdiqlə" basın — xərc hesabatlara düşür.',
    target: 'nav-expenses',
    mobileTarget: 'mobile-nav-expenses',
    placement: 'right',
    navigateTo: '/expenses',
