...
public final class ExpenseSpecification {
    ...
    public static Specification<ExpenseEntity> getSpecification(ExpenseFilterRequest request) {
        return (root, query, cb) -> {
            List<Predicate> predicates = new ArrayList<>();
            equalPredicate(request.getBuildingId(), root.get("building").get("id"), cb)
